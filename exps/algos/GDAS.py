...
if __name__ == '__main__':
  ...
  parser.add_argument('--data_path',         default= '/data/mzhang3/ENNAS_master/data/cifar-10-batches-py', type=str,   help='Path to dataset')
...
# architecture leraning rate
  ...
  parser.add_argument('--save_dir',           type=str,   default='./GDAS_seed1/output/search-cell-nas-bench-102-cifar10',help='Folder to save checkpoints and log.')
